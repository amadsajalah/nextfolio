  ...
  return (
    <nav className="sticky top-0 z-50 flex justify-between bg-gradient-to-r from-orange-50 to-amber-50 px-5 py-3 shadow-md backdrop-blur">
      ...
      <div className="flex w-1/6 justify-end gap-2">
        <a href="https://instagram.com/yourusername" target="_blank" rel="noopener noreferrer" className="cursor-pointer rounded-full p-2 transition-all duration-300 hover:scale-110 hover:bg-orange-200">
        ...
        <a href="https://tiktok.com/@yourusername" target="_blank" rel="noopener noreferrer" className="cursor-pointer rounded-full p-2 transition-all duration-300 hover:scale-110 hover:bg-orange-200">
          <svg className="w-7 h-7 text-gray-800" fill="currentColor" viewBox="0 0 24 24">
            <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
          </svg>
        </a>

        <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="cursor-pointer rounded-full p-2 transition-all duration-300 hover:scale-110 hover:bg-orange-200">
          <svg className="w-7 h-7 text-gray-800" fill="currentColor" viewBox="0 0 24 24">
