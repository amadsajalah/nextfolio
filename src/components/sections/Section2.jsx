export default function Section2() {
  return (
    <section id="about" className="min-h-[70vh] bg-white py-10">
      {/* text about */}
      <div className="mb-12 flex flex-col gap-2">
        <p className="text-center text-xl font-semibold text-gray-800">About Me</p>
        <div className="flex items-center justify-center gap-3">
          <div className="h-1 w-15 border-b-2 border-orange-500" />
